"""THE TOWER OF HANOI, Practicing Pythonic code
...
disks cannot rest on top of a smaller disk."""
    ...
    the lists [5, 4, 3, 2, 1] represents a completed tower. The blank
    list [] represents a tower of no disks. The list [1. 3] has a 
    larger disk on top of a smaller disk and is an invalid
    configuration. The lit [3, 1] is alowed since smaller disks 
...
def get_player_move(towers):
    ...
    while True:  # Keep asking player until they enter a valid move.
        ...
        if len(towers[from_tower]) == 0:
            ...
            # Any disk con be moved onto an empty "to" tower:
